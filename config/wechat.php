...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx468c9b1302205aeb'),         // AppID
    'secret'  => env('WECHAT_SECRET', '977e778ba3b4c37d4e56fc48643295cb'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', '7271757383'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', 'viXovGwSddt8ouWD9beQCo6kUr2d9HYRvTp1qvtp7gz'),                    // EncodingAESKey
