...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-10">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            <strong>{!!trans('admin/breadcrumb.permission.create')!!}</strong>
        </li>
    </ol>
  </div>
</div>
    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5>{!!trans('admin/permission.create')!!}</h5>
        ...
        <div class="ibox-content">
          <form method="post" action="{{url('admin/permission')}}" class="form-horizontal">
            {{csrf_field()}}
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
              <label class="col-sm-2 control-label">{{trans('admin/permission.model.name')}}</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="name" value="{{old('name')}}" placeholder="{{trans('admin/permission.model.name')}}">
                @if ($errors->has('name'))
            ...
            <div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="slug" value="{{old('slug')}}" placeholder="{{trans('admin/permission.model.slug')}}">
                @if ($errors->has('slug'))
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="description" value="{{old('description')}}" placeholder="{{trans('admin/permission.model.description')}}">
              </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="model" value="{{old('model')}}" placeholder="{{trans('admin/permission.model.model')}}">
              </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group">
