...
@endforeach
        ...
        <div class="row clearfix">
            ...
            <hr style="border-top:1px solid #A9A9A9;width:96%">
                <div class="col-md-2 col-sm-2 col-xs-2 column" style="margin-left:3%;">
                    <img style="width:100px;height:100px;" src="{{ $goodinfo->thumbnail }}" alt="">
                </div>
                <div class="col-md-4 col-sm-5 col-xs-5 column" style="margin-left:3%;line-height:200px;">
                {{ $goodinfo->name }}
                </div>
                <div class="col-md-1 col-sm-1 col-xs-1 column" style="line-height:200px;">
                    <p>￥{{ $goodinfo->price }}</p>
                </div>
                <div class="col-md-1 col-sm-2 col-xs-2 column" style="line-height:200px;">
                    <p>数量{{ $goodinfo->num }}</p>
                </div>
                <div class="col-md-1 col-sm-1 col-xs-1 column" style="line-height:200px;">
        ...
        <div class="row clearfix">
            ...
            <div class="col-md-12 column">
                ...
                <ul class="clearfix m-b20 ">
                    <a id="wx" href="{{ asset('/oo') }}/?gid={{ $goodinfo->id }}">
                    ...
                    <a id="zfb" href="{{ asset('/alipay/pay') }}/?gid={{ $goodinfo->id }}">
...
<script type="text/javascript" src="{{ asset('reception/js/jquery-3.1.1.min.js') }}"></script>
    <script>
        function dz(id){
             $("#wx").attr("href","{{ asset('/oo') }}/?gid={{ $goodinfo->id }}&sid="+id+"");
            $("#zfb").attr("href","{{ asset('/alipay/pay') }}/?gid={{ $goodinfo->id }}&sid="+id+"");
        }
    </script>
@endsection
